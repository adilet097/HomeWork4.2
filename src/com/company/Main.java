...
public class Main {
    ...
    public static int heroesHealth[] = {270, 280, 260, 600, 200}; //воин, маг и кинетик
    public static int[] heroesDamage = {20, 15, 25, 6, 10};
    public static String[] heroesAttakType = {"Physical", "Magical", "Kinetik", "Astral", "Luck"};
    ...
    public static String[] newHeroes = {heroesAttakType[3], heroesAttakType[4]};
    ...
    public static void chooseBossDefenceType(String[] heroesAttackType) {
    ...
    public static void heroesHit() {
        for (int i = 0; i < heroesDamage.length; i++) {
            if(heroesHealth[i] > 0 && bossHealth > 0){
                if(heroesAttakType[i] == bossDefenceType) {
                    Random r = new Random();
    ...
    private static void round() {
        roundNumber++;
        chooseBossDefenceType(heroesAttakType);
        luckyDodge();
        bossHits();
        heroesHit();
        printDStatistics();
    ...
    public static void printDStatistics() {
        ...
        for (int i = 0; i < heroesHealth.length ; i++) {
            System.out.println(heroesAttakType[i] + " health: " + heroesHealth[i] + " ["  + heroesDamage[i] + "]" );
        }
    }
    }
